...
class Usuario(models.Model):
    usuario = models.CharField(
        'usuario', max_length=100, null=False, blank=False, unique=True)
    ...
    nivel_de_acesso = models.IntegerField(
        'nivel_de_acesso', null=False, blank=False, default=1)
    email = models.CharField('email', max_length=250, null=False, blank=False, default="email")

class Pagamento(models.Model):
    valor = models.IntegerField('valor', null=False, blank=False, default=0)
    data = models.DateField(
        'data', null=False, blank=False, default=datetime.now())
    tipo = models.IntegerField('tipo', null=False, blank=False, default=0)
    usuario_id = models.IntegerField(
        'usuario_id', null=False, blank=False, default=0)
...
class Playlist(models.Model):
    ...
    desabilitada = models.BooleanField(
        'desabilitada', null=False, default=False)
    descricao = models.CharField(
        'descricao', max_length=255, null=True, default='')
...
class Mensagem(models.Model):
    ...
    mensagem = models.CharField(
        'mensagem', max_length=255, null=False, default="")
    tipo = models.IntegerField('tipo', null=False, default=0)


class Config(models.Model):
    index_video = models.CharField(
        'index_video', max_length=255, null=False, default="")
    index_banner = models.CharField(
        'index_video', max_length=255, null=False, default="")
